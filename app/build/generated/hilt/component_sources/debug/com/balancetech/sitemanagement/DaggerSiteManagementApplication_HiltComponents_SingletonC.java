...
import com.balancetech.sitemanagement.di.DatabaseModule_ProvideUserUnitDaoFactory;
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new UserDetailViewModel(singletonCImpl.provideFeeRepositoryProvider.get(), singletonCImpl.provideExtraPaymentRepositoryProvider.get(), singletonCImpl.provideWaterMeterRepositoryProvider.get(), singletonCImpl.providePaymentRepositoryProvider.get(), singletonCImpl.provideUserRepositoryProvider.get(), singletonCImpl.provideLocalDataSourceProvider.get());
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 6: // com.balancetech.sitemanagement.data.service.FirebaseFunctionsService 
          ...
          return (T) RepositoryModule_ProvideUserRepositoryFactory.provideUserRepository(singletonCImpl.provideLocalDataSourceProvider.get(), singletonCImpl.provideRemoteDataSourceProvider.get(), singletonCImpl.userUnitDao());
