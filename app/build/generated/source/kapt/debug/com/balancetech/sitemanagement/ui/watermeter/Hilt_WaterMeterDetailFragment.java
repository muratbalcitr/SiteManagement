...
public abstract class Hilt_WaterMeterDetailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_WaterMeterDetailFragment() {
    super();
  }

  Hilt_WaterMeterDetailFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WaterMeterDetailFragment_GeneratedInjector) this.generatedComponent()).injectWaterMeterDetailFragment(UnsafeCasts.<WaterMeterDetailFragment>unsafeCast(this));
    }
  }
