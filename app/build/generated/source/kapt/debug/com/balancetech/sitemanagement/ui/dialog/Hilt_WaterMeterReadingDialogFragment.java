...
public abstract class Hilt_WaterMeterReadingDialogFragment extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_WaterMeterReadingDialogFragment() {
    super();
  }

  Hilt_WaterMeterReadingDialogFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WaterMeterReadingDialogFragment_GeneratedInjector) this.generatedComponent()).injectWaterMeterReadingDialogFragment(UnsafeCasts.<WaterMeterReadingDialogFragment>unsafeCast(this));
    }
  }
