...
public abstract class Hilt_WaterMeterFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_WaterMeterFragment() {
    super();
  }

  Hilt_WaterMeterFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WaterMeterFragment_GeneratedInjector) this.generatedComponent()).injectWaterMeterFragment(UnsafeCasts.<WaterMeterFragment>unsafeCast(this));
    }
  }
