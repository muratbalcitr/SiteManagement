...
public abstract class Hilt_CreateFeesForAllUnitsDialogFragment extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CreateFeesForAllUnitsDialogFragment() {
    super();
  }

  Hilt_CreateFeesForAllUnitsDialogFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CreateFeesForAllUnitsDialogFragment_GeneratedInjector) this.generatedComponent()).injectCreateFeesForAllUnitsDialogFragment(UnsafeCasts.<CreateFeesForAllUnitsDialogFragment>unsafeCast(this));
    }
  }
