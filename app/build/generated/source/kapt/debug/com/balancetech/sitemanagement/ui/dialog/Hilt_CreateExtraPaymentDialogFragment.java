...
public abstract class Hilt_CreateExtraPaymentDialogFragment extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CreateExtraPaymentDialogFragment() {
    super();
  }

  Hilt_CreateExtraPaymentDialogFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CreateExtraPaymentDialogFragment_GeneratedInjector) this.generatedComponent()).injectCreateExtraPaymentDialogFragment(UnsafeCasts.<CreateExtraPaymentDialogFragment>unsafeCast(this));
    }
  }
