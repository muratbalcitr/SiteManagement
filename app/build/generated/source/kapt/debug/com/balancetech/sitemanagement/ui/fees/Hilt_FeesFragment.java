...
public abstract class Hilt_FeesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FeesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FeesFragment_GeneratedInjector) this.generatedComponent()).injectFeesFragment(UnsafeCasts.<FeesFragment>unsafeCast(this));
    }
  }
