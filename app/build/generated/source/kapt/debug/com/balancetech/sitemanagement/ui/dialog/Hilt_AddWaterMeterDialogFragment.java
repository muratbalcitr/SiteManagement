...
public abstract class Hilt_AddWaterMeterDialogFragment extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddWaterMeterDialogFragment() {
    super();
  }

  Hilt_AddWaterMeterDialogFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddWaterMeterDialogFragment_GeneratedInjector) this.generatedComponent()).injectAddWaterMeterDialogFragment(UnsafeCasts.<AddWaterMeterDialogFragment>unsafeCast(this));
    }
  }
