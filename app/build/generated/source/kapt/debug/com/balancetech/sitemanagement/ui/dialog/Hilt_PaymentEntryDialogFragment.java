...
public abstract class Hilt_PaymentEntryDialogFragment extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PaymentEntryDialogFragment() {
    super();
  }

  Hilt_PaymentEntryDialogFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PaymentEntryDialogFragment_GeneratedInjector) this.generatedComponent()).injectPaymentEntryDialogFragment(UnsafeCasts.<PaymentEntryDialogFragment>unsafeCast(this));
    }
  }
