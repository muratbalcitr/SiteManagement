...
public abstract class Hilt_CreateFeeDialogFragment extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CreateFeeDialogFragment() {
    super();
  }

  Hilt_CreateFeeDialogFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CreateFeeDialogFragment_GeneratedInjector) this.generatedComponent()).injectCreateFeeDialogFragment(UnsafeCasts.<CreateFeeDialogFragment>unsafeCast(this));
    }
  }
