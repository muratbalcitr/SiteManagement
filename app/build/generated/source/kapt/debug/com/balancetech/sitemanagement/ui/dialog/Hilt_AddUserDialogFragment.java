...
public abstract class Hilt_AddUserDialogFragment extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddUserDialogFragment() {
    super();
  }

  Hilt_AddUserDialogFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddUserDialogFragment_GeneratedInjector) this.generatedComponent()).injectAddUserDialogFragment(UnsafeCasts.<AddUserDialogFragment>unsafeCast(this));
    }
  }
