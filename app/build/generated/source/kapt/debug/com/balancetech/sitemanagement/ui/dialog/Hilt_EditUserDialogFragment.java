...
public abstract class Hilt_EditUserDialogFragment extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EditUserDialogFragment() {
    super();
  }

  Hilt_EditUserDialogFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EditUserDialogFragment_GeneratedInjector) this.generatedComponent()).injectEditUserDialogFragment(UnsafeCasts.<EditUserDialogFragment>unsafeCast(this));
    }
  }
