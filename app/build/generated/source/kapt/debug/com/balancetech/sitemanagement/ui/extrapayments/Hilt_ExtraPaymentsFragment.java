...
public abstract class Hilt_ExtraPaymentsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ExtraPaymentsFragment() {
    super();
  }

  Hilt_ExtraPaymentsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ExtraPaymentsFragment_GeneratedInjector) this.generatedComponent()).injectExtraPaymentsFragment(UnsafeCasts.<ExtraPaymentsFragment>unsafeCast(this));
    }
  }
