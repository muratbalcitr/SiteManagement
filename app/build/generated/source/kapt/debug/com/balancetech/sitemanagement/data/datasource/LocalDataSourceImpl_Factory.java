...
public final class LocalDataSourceImpl_Factory implements Factory<LocalDataSourceImpl> {
  ...
  public LocalDataSourceImpl_Factory(Provider<UserDao> userDaoProvider,
      ...
      Provider<BlockDao> blockDaoProvider) {
  ...
  public LocalDataSourceImpl get() {
    return newInstance(userDaoProvider.get(), feeDaoProvider.get(), paymentDaoProvider.get(), waterMeterDaoProvider.get(), waterBillDaoProvider.get(), notificationDaoProvider.get(), unitDaoProvider.get(), blockDaoProvider.get());
  }
  ...
  public static LocalDataSourceImpl_Factory create(Provider<UserDao> userDaoProvider,
      ...
      Provider<NotificationDao> notificationDaoProvider, Provider<UnitDao> unitDaoProvider,
      Provider<BlockDao> blockDaoProvider) {
    return new LocalDataSourceImpl_Factory(userDaoProvider, feeDaoProvider, paymentDaoProvider, waterMeterDaoProvider, waterBillDaoProvider, notificationDaoProvider, unitDaoProvider, blockDaoProvider);
  }
