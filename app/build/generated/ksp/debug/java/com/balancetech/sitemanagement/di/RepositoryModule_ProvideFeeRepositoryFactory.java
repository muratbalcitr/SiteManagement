...
public final class RepositoryModule_ProvideFeeRepositoryFactory implements Factory<FeeRepository> {
  ...
  public FeeRepository get() {
    return provideFeeRepository(feeDaoProvider.get(), unitDaoProvider.get(), localDataSourceProvider.get(), remoteDataSourceProvider.get(), functionsServiceProvider.get());
  }
  ...
  public static RepositoryModule_ProvideFeeRepositoryFactory create(Provider<FeeDao> feeDaoProvider,
      ...
      Provider<RemoteDataSource> remoteDataSourceProvider,
      Provider<FirebaseFunctionsService> functionsServiceProvider) {
    return new RepositoryModule_ProvideFeeRepositoryFactory(feeDaoProvider, unitDaoProvider, localDataSourceProvider, remoteDataSourceProvider, functionsServiceProvider);
  }
  ...
  public static FeeRepository provideFeeRepository(FeeDao feeDao, UnitDao unitDao,
    ...
    return Preconditions.checkNotNullFromProvides(RepositoryModule.INSTANCE.provideFeeRepository(feeDao, unitDao, localDataSource, remoteDataSource, functionsService));
  }
}
